...
export default function VideoForm() {
  ...
  const { mutate, isLoading: rqLoading } = useCreateVideo()
  ...
  const validate = () => {
    ...
    if (!form.video) e.video='Please select a video'
    return e
  }
  ...
  const handleSubmit = e => {
    ...
    mutate(fd,{
      onSuccess: v=>navigate(`/videos/${v.id}`),
        ...
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-lg relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <label className={`flex items-center p-4 border-dashed border-2 rounded-lg cursor-pointer hover:bg-gray-50 ${
